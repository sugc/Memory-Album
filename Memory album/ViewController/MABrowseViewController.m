...
@interface MABrowseViewController ()<UIAlertViewDelegate,albumRequestProtocol>
...
- (UITableView *)albumTableView{
    if (!_albumTableView) {
        ...
        _albumTableView.header  = [MJRefreshNormalHeader headerWithRefreshingBlock:^(void){
            ...
            [refreshApi getAlbumsWithUserName:[[MAContext sharedContext] localUserProfile].userName andKeyword:@""];
        }];
    }
