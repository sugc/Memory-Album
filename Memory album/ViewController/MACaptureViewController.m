...
#import "MACaptureViewController.h"
#import "MAContext.h"
...
@interface MACaptureViewController ()
...
@implementation MACaptureViewController
...
- (UIButton *)photoButton{
    if (!_photoButton) {
        ...
        [_photoButton setImage:[UIImage imageNamed:@"camera.jpg"] forState:UIControlStateNormal];
        _photoButton.layer.cornerRadius = 7.0;
